...
import styles from './Porodica.module.css';

gsap.registerPlugin(ScrollTrigger);

export default function PorodicaPage() {
    const t = useTranslations('PorodicaPage');
        ...
        <main ref={containerRef} className={styles.pageContainer}>
                ...
                <div className={styles.heroContent}>
                    <h1 className={`${styles.heroTitle} heroTitle`}>
                        ...
                        <span className={`${styles.titleLine} ${styles.titleAccent}`}>
                            {t('title').split('–')[1] || "SIMBOL ZAJEDNIŠTVA"}
                        </span>
                    </h1>
                ...
                <div className={styles.heroImageWrapper}>
                    <div className={styles.imageFrame}>
                        ...
                        <div className={styles.imageInner}>
                            <Image
                                src="/Assets/racije.jpg"
                                alt="Spomenik Porodica"
                                width={600}
                                height={800}
            ...
            <section className={`${styles.factsSection} factsSection`}>
                <div className={styles.factsContainer}>
                    ...
                    <div className={`${styles.factCard} factCard`}>
                        <h3 className={styles.factTitle}>1971</h3>
